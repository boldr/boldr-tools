...
export const ASSETS_MANIFEST_PATH: string = notEmpty(
...
export const IS_DEVELOPMENT: boolean =
  notEmpty(process.env.NODE_ENV) === 'development';
export const PUBLIC_DIR: string = notEmpty(process.env.PUBLIC_DIR);
export const SERVER_PORT: number = parseInt(
  notEmpty(process.env.SERVER_PORT),
  10,
);
export const BUNDLE_ASSETS_FILENAME = notEmpty(
