...
const setupTestsFile = pathExists.sync(path.resolve(ROOT, './.boldr/nodeSetup.js'))
...
module.exports = rootDir => ({
  ...
  setupFiles: [resolveFromUtils('setupNode')],
  setupTestFrameworkScriptFile: setupTestsFile,
  testPathIgnorePatterns: ['<rootDir>/(build|docs|node_modules|images)/'],
  testEnvironment: 'node',
  testRegex: '\\.spec.js$',
  collectCoverage: true,
  coverageDirectory: `${coverageDir}/node/coverage-final.json`,
